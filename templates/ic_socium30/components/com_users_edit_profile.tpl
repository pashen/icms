...
<form id="editform" name="editform" method="post" action="">
	...
	<div style="padding:5px; padding-bottom:15px; margin-bottom:5px;">
		<input class="button" style="font-size:16px" name="save" type="submit" id="save" value="{$LANG.SAVE}" />
        <input class="button" style="font-size:16px" name="chpassbtn" type="button" id="chpassbtn" value="{$LANG.CHANGE_PASS}" onclick="{literal}$('div#change_password').slideToggle();{/literal}" />
		<input class="button" style="font-size:16px" name="delbtn2" type="button" id="delbtn2" value="{$LANG.DEL_PROFILE}" onclick="location.href='/users/{$usr.id}/delprofile.html';" />
	</div>
</form>
...
<div id="change_password" style="display:none">
    ...
    <form id="editform" name="editform" method="post" action="">
        ...
        <div style="padding:5px; padding-bottom:15px; margin-bottom:20px;">
            <input class="button" style="font-size:16px" name="save2" type="submit" id="save2" value="{$LANG.CHANGE_PASSWORD}" />
        </div>
    </form>
</div>