...
<div id="configtabs">
    ...
    <div id="form">
        ...
        <table cellpadding="5" cellspacing="0" style="margin-bottom:10px">
            ...
            <tr>
                <td width="">
                    <strong>Код с видеосервиса:</strong><br/>
            ...
            <tr>
                <td width="">
                    <strong>Описание к видео:</strong><br/>
                    <span class="hint"></span>
                </td>
                <td>
        ...
        <p style="margin-top:15px">
            ...
            {/if}
            <input type="submit" name="submit" value="Добавить" style="font-size:18px" />
