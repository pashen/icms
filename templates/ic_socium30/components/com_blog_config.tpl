<form action="" method="post" name="cfgform" id="cfgform" style="margin-top:5px">
  ...
  <table width="550" border="0" cellpadding="6" cellspacing="0" style="margin-top:6px">
	<tr>
  ...
  <table width="550" border="0" cellpadding="6" cellspacing="0" id="multiblogcfg" style="display:{if $blog.ownertype=='single'}none;{else}block;{/if}">
	<tr>
  ...
  <p style="margin-top:20px">
	<input class="button" name="goadd" type="submit" id="goadd" value="{$LANG.SAVE_CONFIG}" />
	<input class="button" name="delete" type="button" onclick="window.location.href='/blogs/{$id}/delblog.html'" value="{$LANG.DEL_BLOG}" />
