<div class="con_heading">{$LANG.QUESTION_VIEW} {if $is_admin} <a class="faqdel" href="/faq/delquest{$quest.id}.html">[ удалить ]</a>{/if}</div>
				
<table cellspacing="5" cellpadding="0" border="0" width="100%">
	<tr>
		<td width="35" valign="top"><img src="/templates/ic_socium30/images/icons/big/faq_quest.png" border="0" /></td>
		<td width="" valign="top">
...
<table cellspacing="5" cellpadding="0" border="0" width="100%" style="margin:15px 0px;">
	<tr>
		<td width="35" valign="top">
			<img src="/templates/ic_socium30/images/icons/big/faq_answer.png" border="0" />
		</td>
		<td width="" valign="top">
