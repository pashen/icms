{if !$is_homepage}
    ...
    {if $cat.showrss}
        <table cellpadding="0" cellspacing="0" border="0"  width="100%">
			...
			<td width="30" valign="center" style="padding-left:6px">
                        <div class="con_rss_icon">
                            <a href="/rss/content/{$id}/feed.rss" title="{$LANG.RSS}"><img src="/templates/ic_socium30/images/icons/rss.png" border="0" alt="{$LANG.RSS}"/></a>
                        </div>
                </td>

        </table>
    {else}
        <h1 class="con_heading">{php}echo $titdesc[0];{/php}</h1>
    {/if}
			...
			{if $article.user_access}
				{if $col==1} <tr> {/if}
					<td width="20" valign="top">
                        <img src="/templates/ic_socium30/images/icons/article.png" border="0" class="con_icon"/>
                    </td>
					<td width="" valign="top">
						<div class="con_title">
