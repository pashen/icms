...
<form action="" method="POST" name="questform">
	...
	<div>
		<input class="button" type="button" style="font-size:16px;margin-right:2px;margin-top:3px;" onclick="sendQuestion()" name="gosend" value="{$LANG.SEND}"/>
		<input class="button" type="button" style="font-size:16px;margin-top:3px;" name="cancel" onclick="window.history.go(-1)" value="{$LANG.CANCEL}"/>
	</div>
</form>
