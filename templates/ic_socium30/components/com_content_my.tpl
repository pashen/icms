...
<table width="100%" cellpadding="5" cellspacing="0" border="0">
	...
	{foreach key=tid item=article from=$articles}
		<tr>
			...
			<td class="{$article.class}"><img src="/templates/ic_socium30/images/icons/article.png" border="0"></td>
			<td class="{$article.class}"><a href="{$article.href}">{$article.title}</a></td>
			<td class="{$article.class}" align="center">{$article.status}</td>
			<td class="{$article.class}"><img src="/templates/ic_socium30/images/icons/comments.png" border="0"></td>
			...
			<td class="{$article.class}" align="center">
				<a href="/content/edit{$article.id}.html" title="{$LANG.EDIT}"><img src="/templates/ic_socium30/images/icons/edit.png" border="0"/></a>
				{if $user_can_delete}
					<a href="/content/delete{$article.id}.html" title="{$LANG.DELETE}"><img src="/templates/ic_socium30/images/icons/delete.png" border="0"/></a>
				{/if}
			</td>
		</tr>			
	{/foreach}
