...
<div id="configtabs" style="margin-top:20px">
	...
	<div id="about">
		<table width="100%" border="0" cellspacing="0" cellpadding="10" margin-bottom:20px">
			<tr>
			<td colspan="2">
	...
	<div id="members">
		<table width="550" border="0" cellspacing="0" cellpadding="10">
			<tr>
			  <td>{$LANG.MAX_MEMBERS}:<br/><span class="hinttext">{$LANG.MAX_MEMBERS_TEXT}</span> </td>
		...
		<table width="550" border="0" cellspacing="0" id="minkarma" cellpadding="10" style="display: {if $club.clubtype!='public'}none;{else}table;{/if}">
			<tr>
			  <td>{$LANG.USE_LIMITS_KARMA}: <br/><span class="hinttext">{$LANG.USE_LIMITS_KARMA_TEXT}</span></td>
			  <td valign="top">
			...
			<tr>
				<td>
					{$LANG.LIMITS_KARMA}: <br/><span class="hinttext">{$LANG.LIMITS_KARMA_TEXT}</span>
				</td>
