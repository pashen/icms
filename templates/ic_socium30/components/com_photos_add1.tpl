...
<h5 style="border-bottom: solid 1px gray" id="text_mes">
	{$LANG.STEP} 1: {$LANG.PHOTO_DESC}.
</h5>
...
<form action="{$form_action}" method="POST">
	...
	<table width="500">
		...
		<tr>
			<td colspan="2" valign="top"><br/><input class="button" type="submit" name="submit" id="text_subm" value="{$LANG.GO_TO_UPLOAD}" /></td>
		</tr>
	</table>							
</form>