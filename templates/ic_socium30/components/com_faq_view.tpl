	...
	{/if}
		<table width="100%">
			{foreach key=tid item=subcat from=$subcats}
				<tr>
					<td width="40" valign="top"><img src="/templates/ic_socium30/images/icons/big/folder.png" border="0" /></td>
					<td valign="top">
	...
	{foreach key=tid item=quest from=$quests}
		<div class="faq_quest">
			<table cellspacing="5" cellpadding="0" border="0" width="100%">
				<tr>
					<td width="30" valign="top"><img src="/templates/ic_socium30/images/icons/big/faq_quest.png" border="0" /></td>
